...
class ShockModel(BaseModel):
    ...
    air_chamber_diameter_mm: float = 50.8
    body_eyelet_gap_mm: float = 50.8
    shaft_eyelet_gap_mm: float = 50.8
    air_chamber_length_mm: float = 75.0
    air_negative_chamber_length_mm: float = 15.0
    air_piston_head_thickness_mm: float = 5.0
    air_shaft_diameter_mm: float = 25.4
    air_positive_shaft_diameter_mm: float = 8.0
    air_initial_pressure_psi: float = 175.0
